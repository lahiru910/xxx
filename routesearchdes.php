...
<p class="thicker" style="font-family:tahoma;font-size:18px;">Bus Routes for the Destination:<?php  echo $_POST["Destination"];?></p>
...
$result = mysqli_query($conn,"select * from tbl_routen where destination='$des'");
...
{
	?>
	<p class="thick" style="font-family:tahoma;font-size:16px;">Sorry, Destination you search is Not Available.</p>
<?php
}
?>
